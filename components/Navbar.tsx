...
const Navbar = () => {
    ...
    return (
        <nav className="w-full z-50 sticky top-0 shadow-lg">
            ...
            <div className="bg-white border-b border-slate-100">
                <div className="max-w-[1600px] mx-auto px-4 md:px-6 flex items-center justify-between h-20 md:h-24 lg:h-28">
                    ...
                    <Link href="/" className="flex items-center gap-3 md:gap-5 shrink-0 group h-full">
                        <div className="relative flex items-center">
                            <img
                                ...
                                alt="HSGA Logo"
                                className="h-16 sm:h-20 md:h-24 lg:h-26 w-auto object-contain transition-transform duration-500 group-hover:scale-105 drop-shadow-sm"
                            />
                        </div>
                        <div className="flex flex-col justify-center">
                            <h1 className="text-[13px] sm:text-[16px] md:text-[20px] lg:text-[24px] font-[1000] leading-[1.1] text-gray-900 tracking-tighter uppercase whitespace-nowrap">
                                Hindustan Scouts and Guides Association
                            </h1>
                            <h2 className="text-[10px] md:text-[12px] lg:text-[13px] font-[1000] text-orange-600 tracking-[0.4em] md:tracking-[0.6em] uppercase leading-none mt-1">
                                Telangana State
                            </h2>
                        </div>
                    </Link>
                    ...
                    <div className="flex items-center gap-4 lg:gap-8 h-full">
                        ...
                        <button
                            className="xl:hidden p-2 text-[#000080]"
            ...
            <div className="hidden xl:block bg-[#1a4d2e] shadow-md border-t border-white/10">
            ...
            {/* Mobile Menu Overlay */}
            <div className={`xl:hidden overflow-hidden transition-all duration-300 bg-white border-t border-slate-100 ${isMobileMenuOpen ? "max-h-screen" : "max-h-0"}`}>
                <div className="px-6 py-10 flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <Link href="/contact" className="py-5 bg-[#000080] text-white text-center font-[1000] uppercase rounded text-base tracking-[0.2em]" onClick={() => setIsMobileMenuOpen(false)}>
                            Join Now
                        </Link>
                    </div>
                </div>
