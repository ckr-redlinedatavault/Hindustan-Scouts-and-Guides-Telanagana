    ...
    const footerSections = [
        {
            ...
            links: [
                ...
                { name: "Donate", href: "https://hushsga-final.vercel.app/donate" },
            ]
        },
        {
            title: "Resources",
            ...
            <div className="max-w-[1600px] mx-auto px-6 md:px-8">
                    ...
                    <div className="lg:col-span-5 space-y-8">
                        <div className="flex items-center gap-6 md:gap-8">
                            ...
                            <div className="space-y-2 md:space-y-3">
                                <h2 className="text-lg md:text-2xl font-[1000] text-[#000080] tracking-tighter leading-tight uppercase max-w-[240px]">
                                    Hindustan Scouts and Guides Association
                                </h2>
                                <div className="inline-flex items-center border-l-4 border-[#EA580C] pl-4 py-1">
                                    <p className="text-[10px] md:text-[12px] font-[1000] text-gray-500 uppercase tracking-[0.2em]">
                        ...
                        <p className="text-gray-600 text-[14px] md:text-[15px] leading-relaxed font-medium max-w-md">
                ...
                <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-6 text-[12px]">
                    <div className="flex items-center gap-4 md:gap-8 flex-wrap justify-center md:justify-start">
                        <p className="text-gray-400 font-black text-center md:text-left">
                    ...
                    <div className="flex items-center gap-4 md:gap-8 font-[1000] flex-wrap justify-center">
