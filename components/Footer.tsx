    ...
    const footerSections = [
        {
            ...
            links: [
                ...
                { name: "News and portal", href: "/news" },
            ...
            <div className="max-w-[1500px] mx-auto px-6 lg:px-12">
                    ...
                    <div className="lg:col-span-5 flex flex-col items-start">
                        <Link href="/" className="flex items-center gap-5 mb-8 group">
                            ...
                            <div className="flex flex-col">
                                <h2 className="text-xl md:text-2xl font-black text-slate-900 tracking-tighter leading-none">
                                    Hindustan Scouts And <br />
                                    <span className="text-[#000080]">Guides Association</span>
                                </h2>
                                <span className="text-orange-600 font-medium text-sm mt-1 lowercase">
                ...
                <div className="pt-10 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="hidden sm:flex items-center gap-2 text-[11px] font-bold text-slate-400 px-3 py-1 bg-slate-50 border border-slate-100 rounded-sm">
