...
import {
    Users, ArrowRight, Mail, Phone, Award,
    User, ArrowLeft, MapPin, ShieldCheck
} from "lucide-react";
        ...
        <div className="h-screen w-screen bg-white flex font-outfit text-slate-900 overflow-hidden">
            ...
            <div className="hidden lg:block lg:w-1/2 h-full relative">
                ...
                <div className="absolute bottom-12 left-12 z-20 max-w-sm">
                    <h2 className="text-3xl font-bold leading-tight text-white">Join the <br /><span className="text-orange-500">Instructor Corps</span></h2>
                    <p className="text-white/60 text-sm mt-4 font-medium leading-relaxed tracking-wide">
                        Shape the future of youth by becoming a certified trainer with the Hindustan Scouts and Guides Association.
                    </p>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 h-full flex flex-col relative bg-[#fcfcfc] overflow-y-auto custom-scrollbar">
                ...
                <header className="p-8 flex justify-between items-center sticky top-0 bg-[#fcfcfc]/80 backdrop-blur-md z-30">
                    <Link href="/login/trainer" className="group flex items-center gap-2 text-slate-400 hover:text-orange-600 transition-all">
                    ...
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-orange-50 border border-orange-100 rounded-lg">
                        ...
                        <span className="text-[9px] font-bold text-orange-700 uppercase tracking-widest">Enrollment Portal</span>
                    </div>
                </header>
                ...
                <main className="flex-grow p-8 md:p-16 pt-8">
                    <div className="w-full max-w-[500px] mx-auto">
                        ...
                        <div className="mb-10">
                            <h1 className="text-3xl font-bold text-slate-900 tracking-tight mb-2">Trainer Application</h1>
                            <p className="text-slate-500 text-sm font-medium">Register as a certified scouting instructor.</p>
                        </div>
                        ...
                        <form className="space-y-10" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h2 className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Personal</h2>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] ml-1">Date of Birth</label>
                                            <div className="group relative flex items-center bg-white border border-slate-400 rounded-2xl px-5 py-4 transition-all focus-within:border-orange-600 focus-within:shadow-lg focus-within:shadow-orange-900/5">
                                                <input
                                                    type="date"
                                                    className="w-full bg-transparent text-sm focus:outline-none font-medium placeholder:text-slate-300"
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] ml-1">Primary District</label>
                                            <div className="group relative flex items-center bg-white border border-slate-400 rounded-2xl px-5 py-4 transition-all focus-within:border-orange-600 focus-within:shadow-lg focus-within:shadow-orange-900/5">
                                                <select className="w-full bg-transparent text-sm focus:outline-none font-medium appearance-none cursor-pointer">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center gap-3">
                                    ...
                                    <h2 className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Qualifications</h2>
                                    <div className="flex-grow h-px bg-slate-100" />
                                </div>

                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] ml-1">Highest Scouting Rank</label>
                                        <div className="group relative flex items-center bg-white border border-slate-400 rounded-2xl px-5 py-4 transition-all focus-within:border-orange-600 focus-within:shadow-lg focus-within:shadow-orange-900/5">
                                            <input
                                                type="text"
                                                placeholder="e.g. HWB, ALT, LT"
                                                className="w-full bg-transparent text-sm focus:outline-none font-medium placeholder:text-slate-300"
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em] ml-1">Personal Email</label>
                                            <div className="group relative flex items-center bg-white border border-slate-400 rounded-2xl px-5 py-4 transition-all focus-within:border-orange-600 focus-within:shadow-lg focus-within:shadow-orange-900/5">
                                                <Mail className="w-4 h-4 text-slate-300 group-focus-within:text-orange-600 transition-colors" />
                                                <input
                                                    type="email"
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="group relative flex items-center bg-white border border-slate-400 rounded-2xl px-5 py-4 transition-all focus-within:border-orange-600 focus-within:shadow-lg focus-within:shadow-orange-900/5">
                                                <Phone className="w-4 h-4 text-slate-300 group-focus-within:text-orange-600 transition-colors" />
                                                <input
                                                    type="tel"
                                                    placeholder="+91"
                                                    className="w-full bg-transparent pl-4 text-sm focus:outline-none font-medium placeholder:text-slate-300"
                            ...
                            <button className="group w-full relative bg-orange-600 text-white py-5 rounded-xl font-bold flex items-center justify-center gap-3 overflow-hidden transition-all hover:bg-orange-700 active:scale-[0.98] shadow-xl shadow-orange-900/10">
                                <span className="relative z-10 text-xs uppercase tracking-[0.2em]">Submit Application</span>
                        ...
                        <div className="mt-12 pt-8 border-t border-slate-100 text-center">
                            <p className="text-[10px] text-slate-400 font-medium leading-relaxed uppercase tracking-widest">
                                Your application will be reviewed by the State Monitoring Cell. <br />
                                Approval details will be sent via email.
                            </p>
                        </div>
                    </div>
                </main>
                ...
                <footer className="p-8 text-center lg:text-left mt-auto">
                    <p className="text-[9px] text-slate-300 font-bold uppercase tracking-[0.4em]">
                        © 2026 HSGA Telangana • Instructor Network
                    </p>
                </footer>
            </div>
