        ...
        <div className="min-h-screen bg-white flex flex-col font-outfit text-slate-900">
            ...
            <main className="flex-grow">
                ...
                <section className="py-24 max-w-[1500px] mx-auto px-6">
                    <div className="bg-[#000080] p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-10 text-white border-l-[10px] border-orange-600">
                        <div>
                            <h3 className="text-3xl font-[1000] tracking-tighter mb-4 uppercase">Require Specific Documentation?</h3>
                            <p className="text-white/70 font-medium max-w-xl leading-relaxed">
                                If you cannot find a specific circular, order, or form, please contact the State Headquarters directly with your request.
                            </p>
                        </div>
                        <button className="px-10 py-5 bg-white text-[#000080] font-black text-xs uppercase tracking-widest hover:bg-orange-600 hover:text-white transition-all whitespace-nowrap">
                            Contact State HQ
                        </button>
                    </div>
                </section>
